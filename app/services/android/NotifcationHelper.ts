...
import { convertDuration, formatValueToUnit, UNITS } from '~/helpers/formatter';
import { ad } from 'tns-core-modules/utils/utils';

export const ACTION_START = 'com.akylas.cairnmobile.action.START';
export const ACTION_STOP = 'com.akylas.cairnmobile.action.STOP';
export const ACTION_RESUME = 'com.akylas.cairnmobile.action.RESUME';
export const ACTION_PAUSE = 'com.akylas.cairnmobile.action.PAUSE';
export const NOTIFICATION_CHANEL_ID_RECORDING_CHANNEL = 'activelook_service';
...
export class NotificationHelper {
    ...
    public static updateBuilderTexts(builder, session: Session) {
        // if (glasses) {
        // builder.setContentTitle(localize('connected_to_glasses', glasses.name));
        // } else {
    ...
    public static createNotificationChannel(context) {
        ...
        if (android.os.Build.VERSION.SDK_INT >= 26) {
            ...
            const channelName = 'CairnMobile Session State';
