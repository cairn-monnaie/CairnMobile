<template>
    <GridLayout :columns="`${16 * sizeFactor},auto,*,auto,${16 * sizeFactor}`" :rows="`${16 * sizeFactor},auto,*,auto,${16 * sizeFactor}`" backgroundColor="white" :rippleColor="themeColor" @tap="$emit('tap', $event)" >
        ...
        <Label v-if="!!leftIcon" col="1" row="0" rowSpan="5" :fontSize="24* sizeFactor" :marginRight="16* sizeFactor" textAlignment="left" :text="leftIcon" horizontalAlignment="left" verticalAlignment="center" color="#757575" class="mdi" />
        ...
        <Label col="3" row="1" rowSpan="3" v-if="!!rightIcon" class="mdi" :fontSize="24* sizeFactor" textAlignment="right" color="#757575" :text="rightIcon" verticalAlignment="center" />
        <!-- <MDRipple rowSpan="5" colSpan="5" /> -->
        <MDButton variant="flat" col="3" row="1" rowSpan="3" v-if="!!rightButton" class="icon-themed-btn" :text="rightButton" verticalAlignment="center" @tap="$emit('rightTap')" />
