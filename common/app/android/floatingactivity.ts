...
import { AndroidActivityCallbacks, Frame } from '@nativescript/core/ui/frame';
import { View } from '@nativescript/core/ui/core/view';
import {
    categories as traceCategories, isEnabled as traceEnabled, error as traceError, write as traceWrite
} from '@nativescript/core/trace';
import Vue from 'nativescript-vue';
import Floating from '~/components/Floating';
import { CLASS_PREFIX, ROOT_VIEW_CSS_CLASS, getSystemCssClasses, pushToSystemCssClasses } from '@nativescript/core/css/system-classes';
...
class CustomActivityCallbacksImplementation implements AndroidActivityCallbacks {
    ...
    private navEntryInstance: Vue<View>;
    ...
    public onCreate(activity: androidx.appcompat.app.AppCompatActivity, savedInstanceState: android.os.Bundle, intentOrSuperFunc: android.content.Intent | Function, superFunc?: Function): void {
        ...
        if (intent && intent.getAction()) {
            application.android.notify({
                ...
                activity,
                intent
            } as application.AndroidActivityNewIntentEventData);
        }
    ...
    public onNewIntent(activity: androidx.appcompat.app.AppCompatActivity, intent: android.content.Intent, superSetIntentFunc: Function, superFunc: Function): void {
        ...
        console.log('FloatingActivity2', 'onNewIntent', data);
        if (this.navEntryInstance) {
            const floating = this.navEntryInstance.$children[0] as Floating;
    ...
    public onPostResume(activity: any, superFunc: Function): void {
        ...
        if ((activity).isNativeScriptActivity) {
            const args = {
                ...
                object: application.android,
                android: activity
            } as application.ApplicationEventData;
    ...
    public onDestroy(activity: any, superFunc: Function): void {
        ...
        if (this.navEntryInstance) {
            this.navEntryInstance.$destroy();
            this.navEntryInstance = null;
        }
    }
    ...
    public onRequestPermissionsResult(
        ...
        application.android.notify({
            ...
            permissions,
            grantResults
        } as application.AndroidActivityRequestPermissionsEventData);
    }
    ...
    public onActivityResult(
        ...
        application.android.notify({
            ...
            resultCode,
            intent: data
        }as application.AndroidActivityResultEventData);
    }
    ...
    private setActivityContent(
        ...
        if (!rootView) {
            ...
            pushToSystemCssClasses(`${CLASS_PREFIX}${gVars.platform}`);
...
@JavaProxy('com.akylas.cairnmobile.FloatingActivity')
