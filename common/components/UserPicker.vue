            ...
            <GridLayout>
                <GridLayout class="pageContent" rows="auto,*">
                    <StackLayout class="flatCardView"  orientation="horizontal" height="50" margin="10">
                        ...
                        <TextField width="100%" class="input" :hint="$tc('hint_userpicker')" autocorrect="false" autocapitalizationType="none" floating="false" fontSize="17" variant="none" ref="textField" color="black" height="50" verticalAlignment="center" @focus="onFocus" @blur="onBlur" @textChange="onTextChange" paddingRight="5" @loaded="onTFLoaded" />
